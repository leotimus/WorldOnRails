...
from saved_model.nocrash import *

sys.path.append('..')
from rails.saliency_map import *
def make_movie(steer_logits, throt_logits, brake_logits):
    num_frames = 20
    first_frame = 0
    resolution = 75
    save_dir = './movies/'
...
if __name__ == '__main__':
    ...
    parser.add_argument('-f', '--num_frames', default=10, type=int,
                        help='number of frames in movie')  # 30 sec video complied in roughlz 9 min
    ...
    parser.add_argument('-p', '--prefix', default='enlarged', type=str, help='prefix to help make video name unique')
    parser.add_argument('-c', '--checkpoint', default='main_model_16.th', type=str,
