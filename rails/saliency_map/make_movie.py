...
if __name__ == '__main__':
    ...
    parser.add_argument('-f', '--num_frames', default=10, type=int, help='number of frames in movie')#30 sec video complied in roughlz 9 min
    ...
    parser.add_argument('-c', '--checkpoint', default='strong.40.tar', type=str, help='checkpoint name (in case there is more than one')
